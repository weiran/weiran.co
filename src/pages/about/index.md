...
Outside of tech, I enjoy mountain biking and squash. I've been a member of [Racketeers](https://nottssquash.leaguemanagersq.com/?table=teams&idd=2183), a team in the Nottinghamshire Leagues for over 10 years.

### About this blog

This blog is built using [Astro](https://astro.build), and the [source code is available on GitHub](https://github.com/weiran/weiran.co). It's generously hosted for free on [Netlify](https://www.netlify.com).
